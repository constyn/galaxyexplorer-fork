...
public class Canvas extends Graphic {
     ...
     */
    public function copyPixels(source:BitmapData, rect:Rectangle, destPoint:Point, alphaBitmapData:BitmapData = null, alphaPoint:Point = null, mergeAlpha:Boolean = false, brighten:Number = -1):void {
        ...
        if (brighten>0) {
            buffer.colorTransform(new Rectangle(destX, destY, Assets.TILE_SIZE, Assets.TILE_SIZE), new ColorTransform(brighten, brighten, brighten, 1));
        }
